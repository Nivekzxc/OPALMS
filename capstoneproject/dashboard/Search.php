			...
			<div class="wrapper employee_list clearfix">
				<div class="menu-search">
		 		<form method="GET">
			 		...
			 		<input type="submit" name="Searching" value="&#10140;">
		 		</form>
		 	...
		 	<?php
		 		if (isset($_GET['branch'])) {
		 			$SearchedBranch = $_GET['branch'];
					$getbranchsearch = mysql_query("SELECT * FROM tbl_branch WHERE BranchID LIKE '%$SearchedBranch%' OR BranchAddress LIKE '%$SearchedBranch%' OR BranchNumber LIKE '%$SearchedBranch%' ORDER BY BranchNumber ASC");
					$getbranchcount = mysql_num_rows($getbranchsearch);
				?>
				<ul class="emp_list">
					<li class="emp_list_head">
						...
						<div class="branch_item_head branch_name">BranchAddress</div>
						<div class="branch_item_head branch_num">BranchContact</div>
						<div class="branch_item_head branch_num">Action</div>
					</li>
					<div id="displayempList">
						<?php
                            if($getbranchcount >= 1 ){
                                while($fetch = mysql_fetch_array($getbranchsearch)){
                                                ...
                                                <li class="branch_item">
                                                    ...
                                                    <div class="branch_column branch_num">
                                                        <ul class="action_list">
                                                            <li class="action_item action_view" title="View"><a href="../dashboard/viewemployee.php?empid"><i class="fa fa-eye"></i></a></li>
